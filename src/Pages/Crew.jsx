...
function Crew(props) {
  ...
  return (
    <>
      ...
      />
      <img
        className='bg-cover absolute z-[1] bottom-0  lg:right-[137px] max-w-[300px]  lg:max-w-full  right-[200px] hidden sm:block'
      ...
      <div className='absolute sm:top-[150px] top-[100px] lg:top-[212px] left-0 lg:left-[166px]'>
        ...
        <div className='lg:mt-[64px] px-[24px] sm:px-0 mt-0 flex flex-col  items-center lg:items-start text-center lg:text-left w-screen lg:w-full'>
          <img
            className='bg-cover z-[1] top-100  lg:right-[137px] max-w-[300px]  lg:max-w-full right-[200px] block sm:hidden'
            src={`../crew/image-${crewName || props.person}.png`}
          />
          ...
          <p className='text-primary-white w-[444px] text-[15px] sm:text-[16px] lg:text-[18px]'>
            {crewMember[0].bio}
          </p>
